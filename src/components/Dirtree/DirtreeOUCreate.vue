								...
								<v-row justify="center" class="pa-0 ma-0 font-weight-medium">
									<v-col cols="12" lg="5">
										<v-text-field
											...
											:rules="[this.fieldRules(objectToCreate.name, 'ge_cn', true)]"></v-text-field>
									</v-col>
								</v-row>
				...
				<div>
					...
					<v-slide-x-reverse-transition>
						<v-btn
							...
							v-if="this.createStage > 1 && this.error === false"
