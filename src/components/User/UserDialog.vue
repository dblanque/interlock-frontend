...
<template>
	<v-card :loading="refreshLoading" class="pa-0 ma-0">
		...
		<v-expand-transition>
			<div v-show="!refreshLoading">
				...
				<v-tabs v-model="tab" height="0">
											...
											<v-list-item-group active-class="groupSelected">
												<v-list-item v-for="group, key in usercopy.groups" :key="key">
													<template v-slot:default="{ }">
														...
														<v-list-item-content>
															<v-list-item-title>
																{{ group.name + (group.object_relative_id &&
																	group.object_relative_id.length > 0 ?
												...
												<v-row>
													...
													<v-col
														...
														<v-text-field
															dense
															id="account_type"
															:label="$t('attribute.account_type')"
															readonly
												...
												<v-row
													...
													<v-col
														...
														<v-text-field
															...
															:label="$t('attribute.user_account_control')"
															readonly
													...
													<v-col
														...
														<v-btn
															outlined
															color="primary"
															@click="goToTargetTab(TABS.PERMS)"
															class="ma-0 pa-0 py-2 pr-1 pl-3 ma-1">
															{{ $t("actions.changeUserPerms") }}
															<v-icon>mdi-chevron-right</v-icon>
														</v-btn>
												...
												<v-row>
													<v-col
														...
														<v-row justify="center">
															<v-chip
																...
																class="ma-1"
																v-for="i in usercopy.object_class"
																:key="i"
													...
													<v-col
														...
														<v-text-field
															dense
															id="object_category"
															:label="$t('attribute.object_category')"
															readonly
					...
					<v-tab-item :key="2">
						<UserPermissionList
							content-class="ma-0 pa-0 mx-2 pb-4"
				...
				<v-menu
					...
					<v-list
						...
						<v-list-item
							...
							<v-list-item-icon
								color="primary"
								class="mx-0 pa-0 mr-2">
								<v-icon> mdi-cellphone </v-icon>
							</v-list-item-icon>
							<v-list-item-content
								color="primary"
								class="v-list-btn v-btn">
		...
		<v-dialog
			eager
			max-width="1200px"
			v-model="dialogs['userAddToGroup']">
			<CNObjectList
				:dialogKey="'userAddToGroup'"
				ref="UserAddToGroup"
				@addDNs="addToGroup"
