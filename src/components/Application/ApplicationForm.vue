	...
	<v-col class="ma-0 pa-0">
		<!-- Application Form -->
			<v-form ref="ApplicationFormVForm" @submit.prevent>
				...
				<v-row justify="center" align="stretch" class="ma-0 pa-0 px-12">
					<!-- Scope Options -->
					<v-col cols="12" md="5" class="ma-0 pa-0 ma-2">
						<v-card outlined class="pa-4" width="100%" height="100%">
								<v-card-title>
									...
									<v-row no-gutters>
											...
											<v-list flat dense outlined>
												<v-list-item-group>
													...
													<v-list-item dense v-for="scope in localData.scopes" :key="scope">
															<v-list-item-content>
										...
										<v-list flat dense outlined>
											<v-list-item-group>
												<v-list-item
													...
													dense
													v-for="value, key in localData.response_types" :key="key">
													<v-list-item-content>
				...
				<!-- Group Permissions -->
				<v-row justify="center" align="stretch" class="ma-0 pa-0 px-12" v-if="false">
					<!-- Groups to Add -->
					<v-col cols="12" md="5" class="ma-0 pa-0 ma-2">
						<v-card outlined class="pa-4" width="100%" height="100%">
								<v-card-title>
...
export default {
	...
	props: {
		applicationObject: Object | Promise,
		isBeingCreated: {
			type: Boolean,
			default: false
		},
	...
	methods: {
		...
		sync(){
			this.localData = this.applicationObject
		},
		update() {
