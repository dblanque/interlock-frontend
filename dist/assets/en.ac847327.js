const indexTitle = "Interlock - LDAP Manager";
const navgroup = {
	local: "Local Database",
	ldap: "LDAP Back-end",
	ldap_hint: "Enable in Settings"
};
const category = {
	home: "Home",
	"ldap-dirtree": "Directory Tree",
	applications: "SSO Applications",
	"django-users": "Users",
	"application-groups": "Application Groups",
	"ldap-users": "Users",
	"ldap-groups": "Security Groups",
	"ldap-dns": "DNS",
	"ldap-gpo": "GPO",
	"ldap-dns_short": "DNS",
	"ldap-gpo_short": "GPO",
	...
	header: {
		home: "Home",
		"django-users": "Local Users",
		"application-groups": "Application Groups",
		"ldap-dirtree": "Directory Tree",
		"ldap-users": "LDAP Users",
		"ldap-groups": "LDAP Security Groups",
		"ldap-dns": "Domain Name Server",
		"ldap-gpo": "Group Policy Objects",
...
const actions = {
	...
	ldap: {
		configPreset: "Configuration Preset",
		newConfigPreset: "New Preset Name",
		defaultPreset: "Default Preset",
		manual_command: "Manual LDAP Command",
	...
	testSettings: "Test LDAP Settings",
	restoreDefaultValues: "Restore Default Values",
	areYouSure: "Are you sure you wish to",
	label: "Actions",
	revert: "Revert",
	done: "Done",
	enable: "Enable",
	...
	changeEnduserPassword: "Change your Password",
	goToLink: "Go to Link",
	goTo: "Go to",
	search: "Search",
	yes: "Yes",
	...
	changeUserPerms: "View Permissions",
	massChangeUserPerms: "Change Permissions",
	changeUserGroups: "View Groups",
	addObjectClass: "Add Object Class",
...
const words = {
	...
	currently: "Currently",
	notes: "Notes",
	secondaryM: "Secondary",
	secondaryF: "Secondary",
	others: "Others",
...
const classes = {
	...
	"builtin-domain": "Built-in | Built-ins",
	container: "Container | Containers",
	person: "Person | People",
	group: "Group | Groups",
	computer: "Computer | Computers",
	printer: "Printer | Printers",
	"organizational-unit": "Organizational Unit | Organizational Units",
	ou: "OU | OUs",
	setting: "Setting | Settings",
	"setting-preset": "Preset | Presets",
	ldap: "LDAP Object | LDAP Objects",
	"totp-device": "TOTP Device | TOTP Devices",
	application: "Application | Applications",
	"application-group": "Application Group | Application Groups",
	client: "Client | Clients",
	dns: {
		zone: "DNS Zone | DNS Zones",
		record: "DNS Record | DNS Records"
	},
	gpo: {
		normal: "Group Policy Object | Group Policy Objects",
		short: "GPO | GPOs"
	}
};
const error = {
	codes: {
		...
		data_key_missing: "Data Key Missing",
		ldap_unreachable: "LDAP Server Unreachable",
		ldap_backend_disabled: "LDAP Back-end is Disabled",
		ldap_backend_exception: "Unhandled LDAP Back-end Exception",
		improperly_configured: "Improperly Configured",
		applications: {
			application_exists: "SSO Application already exists",
			application_does_not_exist: "SSO Application does not exist",
			application_could_not_be_fetched: "SSO Application could not be fetched",
			application_field_does_not_exist: "Field for SSO Application does not exist",
			application_oidc_client_does_not_exist: "OIDC Client for Application does not exist"
		},
		application_groups: {
			application_group_exists: "Application Group already exists",
			application_group_does_not_exist: "Application Group does not exist"
		},
		auth: {
			invalid_credentials: "Incorrect Credentials",
			verification_code: "Incorrect Code, Please try again",
			verified_successfully: "Verified Successfully",
			verification_expired: "Verification codes have been exhausted, contact an admin"
		},
		dirtree: {
			dirtree_filt_err: "Could not process Directory Tree Filter",
			dirtree_dn_conflict: "Relative and Absolute Distinguished Names cannot be the same",
			dirtree_move_error: "LDAP Object could not be moved",
			dirtree_rename_error: "LDAP Object could not be renamed",
			dirtree_name_not_changed: "LDAP Object name has not changed"
		},
		dns: {
			dns_zone_missing: "Zone Value is invalid",
			dns_zone_foreign: "DNS Zone is foreign and not in this LDAP Server",
			...
			dns_record_type_mismatch: "Record Type Mis-match",
			dns_record_zone_mismatch: "Record Zone Mis-match",
			dns_record_self_reference_conflict: "Record cannot reference itself",
			dns_record_operation_conflict: "Record Operation has conflicting tasks",
			dns_record_exists_conflict: "Record already exists",
			dns_record_does_not_exist: "Record does not exist",
			...
			dns_string_data_limit: "String Data cannot contain more than 255 characters",
			dns_list_response_empty: "LDAP Response does not contain the DNS List",
			dns_value_not_canonical: "Provided value is not a canonical hostname (Must have a trailing dot)"
		},
		users: {
			noUsersInImport: "No Users detected in File",
			user_permission_malformed: "User permissions in request are malformed",
			user_password_over_plain_ldap: "LDAPS is required to change Passwords in Microsoft ADDS",
			user_passwords_dont_match: "User passwords do not match",
			user_old_password_required: "User's old password is required",
			...
			user_email_exists: "A User with that email exists",
			user_entry_not_found: "User LDAP Entry not found",
			user_exists: "A User with that username exists",
			user_not_synced: "No synced user with that name exists",
			user_not_ldap_type: "User is not of LDAP Type",
			user_not_local_type: "User is not of Local Type",
		...
		groups: {
			...
			group_type_missing_field: "Group Type updates require both type and scope"
		},
		settings: {
			setting_type_malformed: "Setting Type Malformed",
			setting_choice_invalid: "Setting Value not within valid choiced",
		...
		ldap: {
			...
			ldap_dn_validation_error: "LDAP Distinguished Name validation error",
			ldap_backend_disabled: "Please enable the LDAP Back-end",
			ldif_bad_field: "LDIF field validation error"
		},
		logs: {
			log_trunc_minmax: "Minimum or Maximum truncate values missing from request"
		},
		organizational_unit: {
			ou_create_error: "Unable to create Organizational Unit",
			ou_field_error: "A field for the Organizational Unit is missing"
		},
		oidc: {
			oidc_invalid_request: "OIDC Request is Invalid",
			oidc_application_fetch: "OIDC Application could not be fetched"
		},
		otp: {
			otp_invalid_code: "OTP Code is invalid",
			otp_invalid_recovery_code: "Recovery Code is invalid",
			otp_invalid_data: "OTP Data is invalid",
			otp_required: "OTP Code is Required",
			otp_no_device_registered: "No OTP Device Registered"
		},
		ldapGwError: "LDAP Server is Unreachable",
		invalidCSV: "Invalid CSV File",
		invalidCSVHeaders: "Invalid CSV Headers",
		fileReader: "File Reader Exception",
		networkError: "AXIOS: Network Error",
		ldapObjectExists: "An LDAP Object with that Identifier Exists",
		namingViolation: "LDAP Naming Violation Exception",
		constraintViolation: "LDAP Constraint Violation Exception",
	...
	validation: {
		...
		domain: "Must be a valid Top-Level Domain ( example.tld )",
		endpoint: "Must be a valid Endpoint ( https://example.tld/endpoint )",
...
const section = {
	home: {
		welcomeMessage: "Welcome to Interlock",
		oidc: {
			title: "OpenID Information",
			issuer: "Issuer",
			authorization_endpoint: "Authorization Endpoint"
		},
		local: {
			title: "User Information",
			local_user_count: "Local User Count",
			ldap_user_count: "Synced LDAP User Count"
		},
		ldap: {
			title: "LDAP Information",
			ldap_enabled: "LDAP Back-end Configured",
			ldap_tls: "LDAP TLS",
			ldap_ssl: "LDAP SSL",
			ldap_ok: "LDAP Back-end Status",
			ldap_active_server: "Active LDAP Server"
		}
	},
	applicationGroups: {
		dialog: {
			create: {
				header: "Create Application Group"
			},
			statusChange: {
				question: "{action} Application Group Filtering",
				enable_warning: "This can accidentally lockout users from your Application",
				disable_warning: "This will allow access to your Application to ANYONE with Interlock Credentials"
			}
		}
	},
	applications: {
		dialog: {
			create: {
				...
				step1: "Configure Application",
				step2: "Creating Application",
				step3: "Application Created",
				redirectUriPlaceholder: "https://<your_service_url>/oidc/callback",
				success: "Application Created Successfully"
			},
			update: {
				copyId: "Copy Client ID",
				copySecret: "Copy Client Secret"
			},
			"delete": {
				message: "Are you sure you wish to delete the SSO Application"
			}
		},
		attribute: {
			name: "Application Name | Application Names",
			redirect_uris: "Redirect URI | Redirect URIs",
			require_consent: "Require Consent",
			reuse_consent: "Re-use Consent",
	...
	dns: {
		...
		ttlDisclaimer: {
			title: "DNS Management Disclaimer",
			messageTtl: "You might need to wait until your Start of Authority TTL expires to see changes effectively applied in your Microsoft ADDS / Samba LDAP server",
			messageLegacyDns: "If you use an older Active Directory or your DNS does not seem to fetch any records/zones, try using the Legacy DNS Option in your Settings."
		}
	},
	login: {
		useEmail: "Use E-Mail",
		useLDAPUser: "Use LDAP Account",
		loginBtn: "Log-in",
		...
		loginForOidc: "OIDC Requires Authentication",
		oidcRequestedByApp: "is requesting to use your Interlock Credentials"
	},
	logs: {
		resetDialog: {
		...
		actionType: {
			...
			RENAME: "Rename",
			MOVE: "Move",
			OPEN_LDAP_CONNECTION: "Opened",
			CLOSE_LDAP_CONNECTION: "Closed"
		}
	},
	enduser: {
		title: "Welcome",
	...
	users: {
		...
		userDialog: {
			...
			hint: {
				...
				primary_group_id: "Only change this if you have Macintosh Clients or POSIX Compliant Applications"
			}
		},
		userBulkUpdate: {
		...
		"import": {
			...
			showCountries: "Show countries list",
			countryList: "LDAP Country List",
			error: {
				save: "Save Error",
				serialization: "Serializer Validation Error",
	...
	groups: {
		...
		types: {
			GROUP_TYPE_DISTRIBUTION: "Distribution Group",
			GROUP_TYPE_SYSTEM: "System Created",
			GROUP_TYPE_SECURITY: "Security Group"
		},
		scopes: {
			GROUP_SCOPE_GLOBAL: "Global Scope",
			GROUP_SCOPE_DOMAIN_LOCAL: "Domain Local Scope",
			GROUP_SCOPE_UNIVERSAL: "Universal Scope"
		},
		groupCreate: {
			header: "Create Group",
			step1: "Group Details",
		...
		groupDialog: {
			...
			typeInBuiltinReadOnly: "Group Type and Scope are Read-Only for Built-ins"
		},
		deleteGroup: {
			title: "Delete Group",
	...
	settings: {
		superAdminIs: "Super-Admin is",
		superAdminPwd: "Change Local Admin Password",
		superAdminPwdConfirm: "Confirm New Password",
		configLabelFieldHint: "Click Save to Rename",
		activePreset: "Active Settings Preset",
		resetDialog: {
		...
		headers: {
			local: {
				title: "Interlock Settings",
				general: "General",
				log: "Logging"
			},
			ldap: {
				title: "LDAP Back-End Settings",
				domain: "Domain",
				bindUser: "Bind User",
		...
		fields: {
			ILCK_ENABLE_LDAP: "Enable LDAP Back-End",
			ILCK_LOG_MAX: "Maximum Logs in Rotation",
			ILCK_LOG_READ: "Log READ Events",
			ILCK_LOG_CREATE: "Log CREATE Events",
			ILCK_LOG_UPDATE: "Log UPDATE Events",
			ILCK_LOG_DELETE: "Log DELETE Events",
			ILCK_LOG_OPEN_LDAP_CONNECTION: "Log OPEN LDAP CONNECTION Events",
			ILCK_LOG_CLOSE_LDAP_CONNECTION: "Log CLOSE LDAP CONNECTION Events",
			ILCK_LOG_LOGIN: "Log Interlock LOGIN Events",
			ILCK_LOG_LOGOUT: "Log Interlock LOGOUT Events",
...
const attribute = {
	...
	object_relative_id: "Relative Identifier",
	object_security_id: "Security Identifier",
	street_address: "Street Address",
	postal_code: "Postal Code",
	city: "City",
	state_province: "State / Province",
	country_name: "Country",
	country_code_dcc: "Country (DCC)",
	country_code_iso: "Country (ISO)",
	country_codes: "Country Codes (DCC/ISO)",
	website: "Website",
	user_principal_name: "User Principal Name",
	user_principal_name_pre2000: "User Principal Name (Pre-2000)",
	user_account_control: "User Account Control",
	created_at: "Created At",
	modified_at: "Modified At",
	last_login: "Last Login",
	last_login_win32: "Last Login (LDAP)",
	bad_password_count: "Bad Password Count",
	password_set_at: "Password Set At",
	...
	group_types: "Group Type | Group Types",
	group_scopes: "Group Scope | Group Scopes",
	is_enabled: "Enabled",
	type: "Type",
	name: "Name",
	builtin: "Built-in",
...
const footer = {
	copyright: "Copyright (C) 2022-2025 | BR Consulting S.R.L.",
	about: "About",
	donate: "Donate"
};
const userAccountDropdown = {
	title: "Account",
	title_long: "Account Preferences",
	logout: "Logout",
	changePreferences: "Change Preferences",
	two_factor_title: "Two-Factor Authentication",
	auto_refresh_token: "Auto-Refresh Token",
	enable_two_factor: "Enable TOTP 2FA",
	showQR: "Show TOTP QR Code",
	hideQR: "Hide QR Code",
	validateTOTP: "Validate TOTP QR Code",
	TOTPnotConfirmed: "Please Confirm your TOTP 2FA",
	recoveryCodes: "Consumable Recovery Codes",
	copyRecoveryCodes: "Copy Codes",
	totpUri: "TOTP URI",
	copyTotpUri: "Copy TOTP URI",
	totpCodeFieldLabel: "6-digit TOTP Code",
	totpValidated: "TOTP Code Validated",
	qrIsEnabled: "TOTP 2FA is enabled",
	qrInfo: "Scan this QR Code with a TOTP Authenticator App"
};
const misc = {
	version: "Version",
...
export { actions, attribute, category, classes, components, contrib, en as default, dns, error, footer, indexTitle, ldap, locale, misc, nav, navgroup, section, userAccountDropdown, words };
//# sourceMappingURL=en.ac847327.js.map
